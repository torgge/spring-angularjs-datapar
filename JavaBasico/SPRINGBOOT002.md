...
Exemplo de utilização dos métodos query no Spring JPA. A anotação @Param é usuda para informar parâmetros da URL, que podem ter nomes diferentes dos parâmtros do método. Se omitidos, nomes dos parâmetros de métodos igual a nomes dos parâmetros da URL.
