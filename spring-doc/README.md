...
Observação: Esta classe deve está um nível acima das classes anotadas com @RestController. Se não, usar a anotação abaixo no lugar de @EnableAutoConfiguration.
